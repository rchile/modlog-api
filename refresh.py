...
"""Obtained from: https://praw.readthedocs.io/en/latest/tutorials/refresh_token.html
...
def receive_connection():
    ...
    Opens a TCP connection on port 5000, and waits for a single client.
    """
